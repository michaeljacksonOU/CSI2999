...
def welcome_window():
    ...
    button_size = 35
    question_button = ctk.CTkButton(frame, width=button_size, height=button_size, image=question_icon, text="",
...
def expense_popup():
    ...
    date_entry = DateEntry(popup, date_pattern="yyyy-mm-dd", background="#2FA571", selectbackground="#2FA571",
                           showweeknumbers=False, firstweekday="sunday", width=25, buttoncolor="#2FA571")
    date_entry.pack()
...
def add_expense():
    ...
    try:
        ...
        # update_labels()
        update_labels(entry2.get(), price)
        ...
        messagebox.showerror("Error",
                             f"The file {expense_file} is not a valid Excel file. Please check the file and try again.")
...
def messagebox_popup():
    ...
    messagebox_label2 = ctk.CTkLabel(popup,
                                     text=f"All entered expenses will be permanently deleted.\nThis action cannot be undone.",
                                     font=("Arial", 14))
