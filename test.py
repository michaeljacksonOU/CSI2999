...
expense_file = r'C:\Users\asila\Downloads\proj\expenses.xlsx'
...
def welcome_window():
    ...
    welcome_label = tk.Label(welcome, text="Welcome to ExpenseExpert!", font=("Arial", 16))
    welcome_label.pack(pady=20)

    # Load and resize the question mark icon
    question_icon = Image.open("C:/Users/asila/Downloads/proj/question_mark.png")
...
def main_window():
    ...
    funds_remaining_label = ctk.CTkLabel(frame1, text="${:,.2f}".format(funds_remaining), anchor="w", font=("Arial", 28))
...
def upload_image():
    ...
    if file_path:
        ...
        if receipt_data:
            ...
            expense_type = simpledialog.askstring("Input", "Enter the expense type (Food, Personal, Work, Home, Transportation, Recurring, Miscellaneous):", parent=root)
